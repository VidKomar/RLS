...
class GetCitiesDataTestCase(unittest.TestCase):
    ...
    def test_get_cities_data(self, mock_soup, mock_get):
        ...
        mock_soup.return_value.find_all.return_value = [
            ...
            type('MockAnchor', (object,), {'has_attr': lambda self, attr: True, 'href': 'test.xml'}),
            type('MockAnchor', (object,), {'has_attr': lambda self, attr: True, 'href': 'test2.xml'})
        ]
        ...
        self.assertEqual(mock_get.call_args[0][0], "http://agromet.mkgp.gov.si/APP2/sl/Home/Index?id=2&archive=0&graphs=1#esri_map_iframe")
